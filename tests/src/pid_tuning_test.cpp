...
protected:
    ...
    {
        Test_With_Plot::test_tuner(&_sine_wave_1, _tuner_1);
    }

    void
    test_tuner_object_state_space_representation()
    {
        Test_With_Plot::test_tuner(&_sine_wave_2, _tuner_2);
    }

private:
    Sine_Wave _sine_wave_1 {time_step, 1.0, 1.0, {}};
    PID pid_1 {time_step, std::vector<double> {0.0, 0.0, 0.0}};
    ObjectEquationT object_differential_equation_representation {
    ...
    Pid_Tuner _tuner_1 {system_1, Recursive_Linear_Regression {}};

    Sine_Wave _sine_wave_2 {time_step, 1.0, 1.0, {}};
    PID pid_2 {time_step, std::vector<double> {0.0, 0.0, 0.0}};
    ObjectStateSpaceT object_state_space_representation {
        time_step,
        order,
        std::vector<double> {0.0, 0.0},
        std::vector<std::vector<double>> {{{0.0, 1.0}, {-0.5, -2.0}}},
    ...
    Pid_Tuner _tuner_2 {system_2, Recursive_Linear_Regression {}};
};
