...
void
Test_With_Plot::test_signal(Signal_Base* signal, std::string signal_plot_title)
{
    signal->reset();
...
void
Test_With_Plot::test_open_loop_control(
    Object_Representation_Base* object, Controller_Base* controller, Signal_Base* input_signal, bool plot_control) const
{
    Plotting_Buffers const buffers =
...
void
Test_With_Plot::test_component(Simulation_Object_Base* component, Signal_Base* input_signal, bool plot_control) const
{
...
Test_With_Plot::Plotting_Buffers const
Test_With_Plot::simulate_signal(Signal_Base* signal)
{
...
Test_With_Plot::Plotting_Buffers const
Test_With_Plot::simulate_open_closed_loop(
    Object_Representation_Base* object, Controller_Base* controller, Signal_Base* input_signal,
...
Test_With_Plot::Plotting_Buffers const
Test_With_Plot::simulate_component(Simulation_Object_Base* object, Signal_Base* input_signal) const
{
    input_signal->reset();
    std::vector<double> time {};
    std::vector<double> set_point {};
